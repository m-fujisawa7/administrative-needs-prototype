...
現在は大阪市、名古屋市、石川県の計14情報源を登録しています。Hatch Technology NAGOYAは名古屋市事業ですが、独自公式ドメインへの安全なアクセス制限のため、名古屋市を親に持つ外部サイト用組織として管理します。

- 大阪市：デジタル統括室RSS、プロポーザル、報道発表、入札・契約、DXの実践、官民連携プラットフォーム、指定管理者の7件（有効6件、参考・無効1件）
